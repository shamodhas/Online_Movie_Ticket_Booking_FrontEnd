...
export default function Footer() {
  return (
    <footer className="border-t text-gray-500">
      <div className="grid p-8 grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 md:gap-8 gap-4">
                        <div className="flex flex-col flex-shrink-1">
                            <div className="font-medium text-white text-ellipsis text-2xl">
                                One Movie
                            </div>
                            <p className="text-sm leading-none text-white mt-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis commodi quisquam in, odit earum maxime minus eos dolor consequuntur nobis et beatae enim, quia minima nemo cupiditate? Ipsa, delectus placeat.</p>
                            <div className="flex items-center gap-x-1 sm:gap-x-4 mt-6">
                                <a href="" target="_blank" rel="noreferrer" className="opacity-50 w-8 h-8 flex-shrink-0 bg-[#e95950] cursor-pointer hover:bg-[#e95950] rounded-full flex items-center justify-center">
                                ...
                                <a href="" target="_blank" rel="noreferrer" className="opacity-50 w-8 h-8 flex-shrink-0 bg-[#00008B] cursor-pointer hover:bg-[#0000c6] rounded-full flex items-center justify-center">
                                    <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                                ...
                                <a href="" target="_blank" rel="noreferrer" className="opacity-50 w-8 h-8 flex-shrink-0 bg-[#0072b1] cursor-pointer hover:bg-[#0072b1] rounded-full flex items-center justify-center">
                                    <svg width="56" height="48" viewBox="-3 10 56 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd"
                                              clipRule="evenodd" d="M20.9716667,33.5527338 L25.001,33.5527338 L25.001,27.1328007 C25.001,25.439485 25.3213333,23.7988354 27.4206667,23.7988354 C29.491,23.7988354 29.517,25.7351486 29.517,27.2404662 L29.517,33.5527338 L33.5506667,33.5527338 L33.5506667,26.4341413 C33.5506667,22.9381777 32.796,20.2505391 28.711,20.2505391 C26.7483333,20.2505391 25.432,21.3265278 24.8943333,22.3471839 L24.839,22.3471839 L24.839,20.5725357 L20.9716667,20.5725357 L20.9716667,33.5527338 Z M16.423,14.1202696 C15.1273333,14.1202696 14.0823333,15.1682587 14.0823333,16.4595785 C14.0823333,17.7508984 15.1273333,18.7992208 16.423,18.7992208 C17.7133333,18.7992208 18.761,17.7508984 18.761,16.4595785 C18.761,15.1682587 17.7133333,14.1202696 16.423,14.1202696 L16.423,14.1202696 Z M14.4026667,33.5527338 L18.4406667,33.5527338 L18.4406667,20.5725357 L14.4026667,20.5725357 L14.4026667,33.5527338 Z M9.76633333,40 C8.79033333,40 8,39.2090082 8,38.2336851 L8,9.76631493 C8,8.79065843 8.79033333,8 9.76633333,8 L38.234,8 C39.2093333,8 40,8.79065843 40,9.76631493 L40,38.2336851 C40,39.2090082 39.2093333,40 38.234,40 L9.76633333,40 Z" id="Shape" fill="#fff"></path>
                                    </svg>
                                </a>
                                <a href="" target="_blank" rel="noreferrer" className="opacity-50 w-8 h-8 flex-shrink-0 bg-[#FF0000] cursor-pointer hover:bg-[#c11818d1] rounded-full flex items-center justify-center">
                        ...
                        <div className=" md:block">
                            ...
                            <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white cursor-pointer">Movies</p>
                            <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white cursor-pointer">Theaters</p>
                        </div>
                        <div className=" md:block">
                        ...
                        <div>
                            <h2 className="text-base font-semibold leading-4 text-white">Contact</h2>
                            <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white cursor-pointer">+94 704 042 310</p>
                            <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white cursor-pointer">+94 704 042 310</p>
                            <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white cursor-pointer">+94 704 042 310</p>
                        </div>
                    </div>
                    <hr />
      <div className="text-center p-4">Shamodha Sahan Rathnamalala / &copy; 2023 All rights reserved</div>
    </footer>
  );
}
